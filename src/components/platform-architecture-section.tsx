...
export function PlatformArchitectureSection({
  ...
  const content = (
    <div className="grid w-full items-center gap-10 lg:mt-20 lg:grid-cols-[minmax(0,240px)_minmax(0,1fr)_minmax(0,280px)] lg:gap-8 xl:gap-12">
